...
<script  type="text/javascript">
    ...
    function toggle_pur(source) {
    	checkboxes_ack = document.getElementsByClassName('pur');
		for(var i=0, n=checkboxes_ack.length;i<n;i++) {
            checkboxes_ack[i].checked = source.checked;
        }
    }
    ...
    $(document).ready(function() {
		...
		$("#checkAll").click(function () {
		    $('#checkpur').not(this).prop('checked', this.checked);
		});
	});
</script>
							...
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<tr style="background-color: #ffe08e4a">
										...
										<td align="center"><input style="height: 20px" type="checkbox" onClick="toggle_pur(this)" name="halo" class="form-control pur" ><span class="fa fa-caret-down"></span></td>
									...
									<tr>
										...
										<?php }?>
										<?php if($emp['purchaser'] == '0'){ ?>
										<td><input style="height: 20px" type="checkbox" name="purchaser<?php echo $count?>" value = "1" class="form-control pur" id="checkpur"></td>
										<?php } else{ ?>
										<td><input style="height: 20px" type="checkbox" name="purchaser<?php echo $count?>" value = "1"<?php echo ((strpos($emp['purchaser'], "1") !== false) ? ' checked' : '');?> class="form-control pur" id="checkpur"></td>
										<?php }?>
