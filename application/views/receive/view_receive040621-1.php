				...
				<div class="panel-body">
					<div class="canvas-wrapper">
						...
						<table style="border-top: 1px solid #dedede" width="100%">	
							...
							<tr>
								<td width="5%"></td>
								<td width="5%" align=""><p class="nomarg">Date:</p></td>
							...
							<tr>
								<td></td>
								<td align=""><p class="nomarg">DR #:</p></td>
								<td> <h5 class="nomarg"><?php echo $h->dr_no; ?></h5></td>
								<td align=""><p class="nomarg">PO #:</p></td>
								<td> <h5 class="nomarg"><?php echo $h->po_no; ?></h5></td>
							</tr>
							<tr>
								<td></td>
								<td align=""><p class="nomarg">PCF #:</p></td>
								<td> <h5 class="nomarg"><?php if($h->pcf == '1'){ echo "Yes"; }else { echo ""; } ?></h5></td>
								<td align=""><p class="nomarg">Waybill #:</p></td>
								<td> <h5 class="nomarg"></h5><?php echo $h->waybill; ?></td>
							</tr>
							<tr>
								<td></td>
								<td align=""><p class="nomarg">SI #:</p></td>
