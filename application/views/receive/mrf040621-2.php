        ...
        <div class="container">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td><label class="nomarg">:&nbsp; <?php echo $wbno;?></label></td>
                </tr>
        ...
        <div class="col-lg-12">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td></td>
                    <td style="border-bottom:1px solid #000">
                        <select class="select" type="text" name='purchaser' id='purchaser' onchange="choosePurchaser()">
                            <option></option>
                            <?php foreach($purchaser_emp AS $pur){ ?>
                            <option value = "<?php echo $pur['empid'];?>" <?php echo (($pur['empid'] == $purchaser) ?  ' selected' : ''); ?>><?php echo $pur['empname'];?></option>
                            <?php } ?>
                        </select> 
                    </td>
                    <td></td>                
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="positionpurchaser" class="select" style="pointer-events:none" value="<?php echo $us['positionpurchaser'];?>">
                    </td>                
                    <td>
